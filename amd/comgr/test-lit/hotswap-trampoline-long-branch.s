// COM: A0 cannot execute s_add_pc_i64. Far edges use an SCC-neutral SGPR-pair
// COM: get-PC / s_add_nc_u64 / set-PC sequence (no third SCC-save SGPR). A
// COM: large non-NOP .rept filler (~160 KB) pushes the appended pool past
// COM: s_branch's reach, forcing the far return set-PC; the 16-byte forward
// COM: edge now fits directly in the source slot as an in-place set-PC.
...
// COM: A kernel with no aligned SGPR pair fails closed instead of
